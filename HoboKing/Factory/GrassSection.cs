...
namespace HoboKing.Factory
{
    ...
    {
        public GrassSection(List<Tile> standardTiles, string Level, int MAP_WIDTH, int MAP_HEIGHT, int sectionStartPosition, int sectionEndPosition) : base(standardTiles, Level, MAP_WIDTH, MAP_HEIGHT, sectionStartPosition, sectionEndPosition)
        {
        }
